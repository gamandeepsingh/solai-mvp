...
export default function PrivacyPage() {
  return (
    <main className="min-h-screen bg-[var(--bg)] text-[var(--ink)] px-6 py-16">
      <div className="max-w-3xl mx-auto space-y-8">
        <header className="space-y-3">
          <p className="text-xs tracking-[0.2em] uppercase text-[var(--ink-tertiary)]">Privacy Policy</p>
          <h1 className="text-3xl sm:text-4xl font-semibold tracking-tight">Privacy Policy — SOLAI Wallet</h1>
          <p className="text-sm text-[var(--ink-tertiary)]">Last Updated: 20 Mar 2026</p>
        </header>

        <section className="space-y-4 text-sm text-[var(--ink-secondary)] leading-relaxed">
          <h2 className="text-lg text-[var(--ink)] font-medium">1. Introduction</h2>
          <p>
        ...
        <section className="space-y-4 text-sm text-[var(--ink-secondary)] leading-relaxed">
          <h2 className="text-lg text-[var(--ink)] font-medium">2. Information We Collect</h2>
          <div className="space-y-2">
            <p className="text-[var(--ink)]">a. Information You Provide</p>
          ...
          <div className="space-y-2">
            <p className="text-[var(--ink)]">b. Automatically Collected Information</p>
            <ul className="list-disc pl-5 space-y-1">
        ...
        <section className="space-y-4 text-sm text-[var(--ink-secondary)] leading-relaxed">
          <h2 className="text-lg text-[var(--ink)] font-medium">3. What We Do NOT Collect</h2>
        ...
        <section className="space-y-4 text-sm text-[var(--ink-secondary)] leading-relaxed">
          <h2 className="text-lg text-[var(--ink)] font-medium">4. How We Use Your Data</h2>
          <p>We use data to:</p>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section className="space-y-4 text-sm text-[var(--ink-secondary)] leading-relaxed">
          <h2 className="text-lg text-[var(--ink)] font-medium">5. AI and Third-Party Services</h2>
        ...
        <section className="space-y-4 text-sm text-[var(--ink-secondary)] leading-relaxed">
          <h2 className="text-lg text-[var(--ink)] font-medium">6. Data Storage</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section className="space-y-4 text-sm text-[var(--ink-secondary)] leading-relaxed">
          <h2 className="text-lg text-[var(--ink)] font-medium">7. Security</h2>
        ...
        <section className="space-y-4 text-sm text-[var(--ink-secondary)] leading-relaxed">
          <h2 className="text-lg text-[var(--ink)] font-medium">8. Your Responsibility</h2>
        ...
        <section className="space-y-4 text-sm text-[var(--ink-secondary)] leading-relaxed">
          <h2 className="text-lg text-[var(--ink)] font-medium">9. Children’s Privacy</h2>
          <p>SOLAI Wallet is not intended for users under 18.</p>
        </section>

        <section className="space-y-4 text-sm text-[var(--ink-secondary)] leading-relaxed">
          <h2 className="text-lg text-[var(--ink)] font-medium">10. Changes to This Policy</h2>
          <p>We may update this Privacy Policy from time to time. Updates will be reflected with a new “Last Updated” date.</p>
        </section>

        <section className="space-y-4 text-sm text-[var(--ink-secondary)] leading-relaxed">
          <h2 className="text-lg text-[var(--ink)] font-medium">11. Contact</h2>
